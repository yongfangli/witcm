...
//	private String parentIds;// 所有父级编号
	private String module; 	// 栏目模型（article：文章；news:新闻类picture：图片；download：下载；link：链接；special：专题）
//	private String name; 	// 栏目名称
	private String image; 	// 栏目图片
	private String href; 	// 链接
	private String pcLink;  //pc端的链接
...
//	private Integer sort; 		// 排序（升序）
	...
	private String IndexLink;//前台文章首页链接
