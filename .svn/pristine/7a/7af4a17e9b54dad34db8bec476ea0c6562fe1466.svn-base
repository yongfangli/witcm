...
<link href="${ctxStatic}/bootstrap/2.3.1/css_${not empty cookie.theme.value&&cookie.theme.value!='null' ? cookie.theme.value : 'cerulean'}/bootstrap.min.css" type="text/css" rel="stylesheet" />
...
jQuery.validator.addMethod("isborth", function(value, element) {
	var reg=/^((?:19|20)\d\d)-(0[1-9]|1[012])-(0[1-9]|1[1-9]|2[1-9]|3[0-1])$/;
