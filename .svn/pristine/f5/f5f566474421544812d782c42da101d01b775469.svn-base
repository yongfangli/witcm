...
<div class="bigdiv">
    <!--左边列表-->
    <div class="list_left">
        <div class="title"><a href="${ctx}/itv "><img class="return" src="${ctxStaticItv }/images/return.png" ></img></a> 周边商户</div>
    ...
    <div class="left_user">
      <div class="left_content">
        ...
        <div class="user_cont">
           ...
           <c:if test="${flag=='0' }">
            <button onclick="supermarket(1)" id="seller" class="seller">商家介绍</button>
            <button onclick="supermarket(2)" id="goods" class="goods">商品</button>
            <button onclick="supermarket(3)" id="comment" class="goods">评论</button>
            </c:if>
              <c:if test="${flag=='1' }">
            <button onclick="supermarket(1)" id="seller" class="goods">商家介绍</button>
            <button onclick="supermarket(2)" id="goods" class="seller">商品</button>
            <button onclick="supermarket(3)" id="comment" class="goods">评论</button>
            </c:if>
              <c:if test="${flag=='2' }">
            <button onclick="supermarket(1)" id="seller" class="goods">商家介绍</button>
            <button onclick="supermarket(2)" id="goods" class="goods">商品</button>
            <button onclick="supermarket(3)" id="comment" class="seller">评论</button>
            </c:if>
            <!--商家介绍-->
            <c:if test="${flag=='0' }">
            <div class="content">
            ...
            <div class="goodsDiv" style="display:none">
             <c:if test="${gpage.count gt 0}">
                ...
                <div class="last_page" >
   <c:if test="${!gpage.firstPage}"><a style="color: #101010;" onclick="prev('${ctx}/itv/businessDetail?businessId=${business.id}&cpageNo=${cpageNo}&gpageNo=${gpage.prev}')" href="javascript:void(0)">▲</a></c:if>&emsp;${gpage.pageNo}/${gpage.last}&emsp; <c:if test="${!gpage.lastPage}"><a style="color: #101010;"  onclick="prev('${ctx}/itv/businessDetail?businessId=${business.id}&cpageNo=${cpageNo}&gpageNo=${gpage.next}')" href="javascript:void(0)">▼</a></c:if>
</div>
</c:if>
