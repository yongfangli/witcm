...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/business/business/add">商户添加</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="business" action="${ctx}/business/business/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="describes" htmlEscape="false" rows="4" style="width:570px;" maxlength="2000" class="input-xxlarge required"/>
				<span class="help-inline"><font color="red">*</font></span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="remarks" htmlEscape="false" rows="4" style="width:570px;" maxlength="2000" class="input-xxlarge "/>
			</div>
		</div>
