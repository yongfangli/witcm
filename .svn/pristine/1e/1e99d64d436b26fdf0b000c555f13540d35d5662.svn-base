...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#telphoneNo").val($("#telphoneNo").attr("telphoneno"));
...
<body>
	...
	<form:form id="inputForm" modelAttribute="business" action="${ctx}/business/business/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="telphoneNo" telphoneno="${business.telphone}" name="telphone" class="input-xlarge required" type="text"  maxlength="30"/>
				<span class="help-inline"><font color="red">*</font></span>
			</div>
		</div>
		<div class="control-group">
