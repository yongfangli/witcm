...
public class ArticleService extends CrudService<ArticleDao, Article> {
	...
	public void save(Article article) {
		if (null != article.getArticleData()
				&& article.getArticleData().getContent() != null) {
		...
		if (StringUtils.isBlank(article.getId())) {
			...
			if (null != article.getArticleData()) {
				articleData = article.getArticleData();
				articleData.setId(article.getId());
				ArticleData articData = articleDataDao.get(article.getId());
				if(articData==null){
					articleDataDao.insert(article.getArticleData());
				}else{
	...
	public List<Article> getList(String categoryId, String siteId,
			String communityId, int num) {
		// TODO Auto-generated method stub
		return dao.getList(categoryId, siteId, communityId, num);
	}
	...
	public int getCommentCount(String articleId) {
		...
		comments.setArticle(new Article(articleId));
		List<Comments> commentsList = commentsDao.findList(comments);
