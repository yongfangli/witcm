...
<body>
		<div id="out">
			...
			<div class="div_center a2" style="display: inline-block;">
				<div class="content">
			...
			<div class="bottom">
				...
				<c:if test="${null!=pre }">
					<a target="_blank" href="${ctx}/news-view-${pre.id}${fns:getUrlSuffix()}"> <上一篇 </a>
				...
				<c:if test="${null!=next}">
					...
					<a target="_blank" href="${ctx}/news-view-${next.id}${fns:getUrlSuffix()}"> 下一篇> </a>
