...
<%@ attribute name="placeholderData" type="java.lang.String" required="false" description="提示信息"%>
<input type="text" id="${name}" name="${name}" maxlength="5" class="txt required" style="${inputCssStyle}" placeholder="${placeholderData}"/>
