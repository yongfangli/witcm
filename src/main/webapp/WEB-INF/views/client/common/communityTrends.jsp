...
<head>
	...
	<c:if test="${status.index==1 }">
		...
		<div class="div_content">
			<a href="${ctxClient}/articleDetail${fns:getUrlSuffix()}/${article.id}/?pageName=communityTrendsDetail"  target="_blank">${article.title}</a>
     ...
     $('#box').paging({
    	...
    	$("#pageSelect li").click(function(){
    		var pageNo=this.innerText;
    		 var url='${ctxClient}'+"/articleList.html/"+categoryId+"/?pageName=communityTrends"+"&pageNo="+pageNo;
