...
<head>
	...
	<c:if test="${status.index==1 }">
		...
		<div class="div_content" style="display:block;">
			<a href="${ctxClient}/articleDetail${fns:getUrlSuffix()}/${article.id}/?pageName=communityLegalDetail"  target="_blank">${article.title}</a>
     ...
     $('#box').paging({
    	...
    	$("#pageSelect li").click(function(){
    		var pageNo=this.innerText;
    		 var url='${ctxClient}'+"/articleList.html/"+categoryId+"/?pageName=communityLegalDetail"+"&pageNo="+pageNo;
