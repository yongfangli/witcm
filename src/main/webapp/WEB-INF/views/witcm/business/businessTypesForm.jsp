...
<body>
	...
	<form:form id="inputForm" modelAttribute="businessTypes" action="${ctx}/business/businessTypes/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:hidden id="imagesUrl" path="imagesUrl" htmlEscape="false" maxlength="64" class="input-xlarge"/>
				<sys:ckfinder input="imagesUrl" type="images" uploadPath="/businessTypes/images" selectMultiple="false" maxWidth="90" maxHeight="110"/>
			</div>
		</div>
		<div class="control-group">
