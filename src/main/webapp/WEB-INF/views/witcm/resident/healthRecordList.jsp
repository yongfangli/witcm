		...
		<ul class="ul-form">
			<li><label>家属：</label>
			 <sys:treeselect id="familyUser" name="familyUser.id" value="${healthRecord.familyUser.id}" labelName="familyUser.name" labelValue="${healthRecord.familyUser.name}"
					title="家属" url="/resident/family/treeData" cssClass="input-medium required" allowClear="true" notAllowSelectParent="true"/>
			</li>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="healthRecord">
			<tr>
				...
				<td>
					${healthRecord.bloods}/${healthRecord.tbloods}
				</td>
				<td>
