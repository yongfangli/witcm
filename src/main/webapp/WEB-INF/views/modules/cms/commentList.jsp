...
<body>
	...
	<table id="contentTable" class="table table-bordered table-condensed">
		<thead><tr><th>评论内容</th><th>文档标题</th><th>评论人</th><th>评论时间</th><th nowrap="nowrap">操作</th></tr></thead>
		<tbody>
		...
		<td><a onclick="return confirmx('确认要该评论吗？', this.href)"  href="${ctx}/cms/comment/deleteC?id=${comment.id}">删除</a></td>
		</tr>
		</c:forEach>
		<%-- <c:forEach items="${page.list}" var="comment">
			<tr>
