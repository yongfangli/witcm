           ...
           if(type=='special'){
            ...
            data.forEach(function( val, index ) {
                ...
                "<br/>发布时间："+date+"</div></div></li></a>";
            		...
            		html=html+"<div class='interval'></div><div class='username' style='height: 11vh'>"+
         	   		"<img src='"+val.image+"' class='userlogo'><div style='float:right;width:70vw'>"+
       	       	  "<div style='height:2vh'></div>  <p style='font-size: 0.7em'>"+title+"</p>"+
       	         "<p class='comm'>"+val.user.name+" ｜ "+date+" </p> </div> <div style='clear:both'></div></div>";
            	}
             })
            if(html==''){
            	$(".more").text("已经是最后一页了");
...
<div class="wrap_box">
  ...
  <c:forEach items="${categoryListc}" var="c" varStatus="sta">
   ...
   <div style="height:2vh;background:#CCC;width:100vw;margin-top:2vh"></div>
