...
<body>
		<div id="out">
			...
			<div class="div_center a6" style="display: inline-block;">
				<div class="content">
			...
			<div class="bottom">
				...
				<c:if test="${null!=pre }">
					<a target="_blank" href="${ctx}/guide-view-${pre.id}${fns:getUrlSuffix()}"> <上一篇</a>
				...
				<c:if test="${null!=next}">
				  ${fns:abbr(next.title,80)}
					<a target="_blank" href="${ctx}/guide-view-${next.id}${fns:getUrlSuffix()}"> 下一篇> </a>
