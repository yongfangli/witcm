	...
	<script type="text/javascript">
		var setting = {data:{simpleData:{enable:true,idKey:"id",pIdKey:"pId",rootPId:'0'}},
			callback:{onClick:function(event, treeId, treeNode){
					...
					var oname=encodeURI(encodeURI("${ctx}/sys/user/list?office.id="+id+"&office.name="+treeNode.name));
					$('#officeContent').attr("src",oname);
				}
			}
		};
		
		function refreshTree(){
			$.getJSON("${ctx}/sys/office/treeData?type=2",function(data){
